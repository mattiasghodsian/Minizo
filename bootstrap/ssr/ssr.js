...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-DVpp5MyT.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-CbLJESg2.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-nvyHceGu.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-qG9oocUz.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-TYyYfgwF.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-DpABZfJT.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-Bn6GnvZB.js"), "./Pages/Library/View.vue": () => import("./assets/View-CkX2k4CK.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-BnJ7tEj_.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-E3_Z9tHs.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-BaC6Cd1O.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-DbVdjtoa.js") })
    ),
