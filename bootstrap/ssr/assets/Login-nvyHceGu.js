...
import { _ as _sfc_main$2 } from "./GuestLayout-B9jvM3Mh.js";
import { _ as _sfc_main$5 } from "./InputError-D7Pvlg8p.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./TextInput-DqLOxehv.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="ms-2 text-sm text-gray-600 dark:text-gray-400"${_scopeId}>Remember me</span></label></div><div class="mt-4 flex flex-col items-center gap-2 justify-center"${_scopeId}>`);
            ...
            if (__props.canResetPassword) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                class: "text-sm underline text-gray-400 hover:text-white transition-all delay-150"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "mt-4 flex flex-col items-center gap-2 justify-center" }, [
                  ...
                  __props.canCreateAccount ? (openBlock(), createBlock(unref(Link), {
                    key: 1,
                    href: _ctx.route("register"),
                    class: "text-sm underline text-gray-400 hover:text-white transition-all delay-150"
                  }, {
