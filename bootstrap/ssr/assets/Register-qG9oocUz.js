      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mt-4 flex flex-col gap-2 items-center justify-center"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "mt-4 flex flex-col gap-2 items-center justify-center" }, [
